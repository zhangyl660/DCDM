...
class OfficeHome_D(ImageList):
    """`OfficeHome <http://hemanthdv.org/OfficeHome-Dataset/>`_ Dataset with domain_label
    ...
    def __init__(self, root: str, task: str, download: Optional[bool] = False, **kwargs):
        ...
        super(OfficeHome_D, self).__init__(root, OfficeHome_D.CLASSES, data_list_file=data_list_file, **kwargs)
